...
public class Item {
    ...
    private void loadItemTexture() {
        try {
            String texturePath;
            switch (level) {
                case 1: texturePath = "D:\\Computer Graphics\\Project2D\\level1.png"; break;
                case 2: texturePath = "D:\\Computer Graphics\\Project2D\\level2.png"; break;
                case 3: texturePath = "D:\\Computer Graphics\\Project2D\\level3.png"; break;
                default: texturePath = "D:\\Computer Graphics\\Project2D\\level1.png"; break;
            }
